      ...
      <section className="py-16 px-4 bg-white text-gray-900">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed">
            ...
            years honing in on my people skills and developed a strong
            ...
            to overcome challenges. Outside of tech, I'm an avid fan of outdoor
            activities, particularly skiing, and I'm always eager to connect
            with others who share my enthusiasm for innovation and the great
            outdoors.
          </p>
        </div>
